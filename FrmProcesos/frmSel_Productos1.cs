...
{
    public partial class frmSel_Productos1 : Form
    {
        public frmSel_Productos1()
        {
            InitializeComponent();
        }

        private void frmSel_Productos1_Load(object sender, EventArgs e)
        {
        ...
        private void carga_grilla()
        {
            ...
            try
            {
                ...
                objproducto.cls_consultar_Productos1(t_buscar.Text.Trim(), t_buscar1.Text.Trim());
