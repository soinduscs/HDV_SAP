...
{
    public partial class frmRecepcionMPA6 : Form
    {
        public frmRecepcionMPA6()
        {
            InitializeComponent();
        }

        private void frmRecepcionMPA6_Load(object sender, EventArgs e)
        {
        ...
        private void carga_grilla1()
        {
            ...
            try
            {
                ...
                objproducto.cls_Consulta_Partidas_recepcion_mp("Q");
