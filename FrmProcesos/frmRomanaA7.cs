...
{
    public partial class frmRomanaA7 : Form
    {
        public frmRomanaA7()
        {
            InitializeComponent();
        ...
        private void frmRomanaA7_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (t_menu.Text == "Menu")
            {
                frmRomanaA6 f2 = new frmRomanaA6();
        ...
        private void carga_grilla()
        {
            ...
            try
            {
                ...
                objproducto.cls_Consulta_Partidas_x_fecha1_dys(fecha);
