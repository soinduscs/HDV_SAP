...
{
    public partial class frmCalidadPPB3 : Form
    {
        public frmCalidadPPB3()
        {
            InitializeComponent();
        }

        private void frmCalidadPPB3_Load(object sender, EventArgs e)
        {

            clsCalidad objproducto2 = new clsCalidad();
            objproducto2.cls_Consulta_ATRP9l_plus(VariablesGlobales.glb_MatrizAtr, VariablesGlobales.glb_CodAtr, VariablesGlobales.glb_Referencia1);
