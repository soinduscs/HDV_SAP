...
{
    public partial class frmRecepcionMPB9 : Form
    {
        public frmRecepcionMPB9()
        {
            InitializeComponent();
        }

        private void frmRecepcionMPB9_Load(object sender, EventArgs e)
        {
        ...
        private void carga_grilla1()
        {
            ...
            try
            {
                ...
                objproducto.cls_Consulta_Partidas_recepcion_mp("Z");
