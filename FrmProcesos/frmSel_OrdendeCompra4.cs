...
{
    public partial class frmSel_OrdendeCompra4 : Form
    {
        public frmSel_OrdendeCompra4()
        {
            InitializeComponent();
        }

        private void frmSel_OrdendeCompra4_Load(object sender, EventArgs e)
        {
            carga_grilla();
        ...
        private void carga_grilla()
        {
            ...
            try
            {
                ...
                objproducto.cls_Consultar_Ordenes_de_compra_abiertas_bodegaje(t_buscar.Text);
