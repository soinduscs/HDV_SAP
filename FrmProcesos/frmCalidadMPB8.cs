...
{
    public partial class frmCalidadMPB8 : Form
    {
        public frmCalidadMPB8()
        {
            InitializeComponent();
        }

        private void frmCalidadMPB8_Load(object sender, EventArgs e)
        {
            Grid1.Rows.Clear();
            Grid2.Rows.Clear();
        ...
        private void carga_grilla_consumo(string cCardCode)
        {
            ...
            try
            {
                ...
                objproducto.cls_utiles_resumendespelonado(cCardCode, "I", 2021);
        ...
        private void carga_grilla_recibos(string cCardCode)
        {
            ...
            try
            {
                ...
                clsCalidad objproducto = new clsCalidad();
                objproducto.cls_utiles_resumendespelonado(cCardCode, "E", 2021);
