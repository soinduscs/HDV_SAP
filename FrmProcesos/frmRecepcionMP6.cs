...
{
    public partial class frmRecepcionMP6 : Form
    {
        public frmRecepcionMP6()
        {
            InitializeComponent();
        }

        private void frmRecepcionMP6_Load(object sender, EventArgs e)
        {
            ...
            objproducto6.cls_lee_localidades();

            cbb_localidad.DataSource = objproducto6.cResultado;
            cbb_localidad.ValueMember = "Code";
            cbb_localidad.DisplayMember = "Location";

            try
            {
                cbb_localidad.SelectedValue = VariablesGlobales.glb_Localidad;
            ...
            objproducto3.cls_ConsultaLista_Almacenes_X_Localidad(VariablesGlobales.glb_Localidad);
            ...
            if (DocNum > 0)
            {
                ...
                objproducto8.cls_Consultar_Ordenes_de_compra_x_numero(DocNum, t_itemcode.Text,0);
        ...
        private void btn_recibir_Click(object sender, EventArgs e)
        {
            ...
            if (cLocalidad == "")
            {
                MessageBox.Show("Debe seleccionar una localidad válido, opción Cancelada", "Recepción de Materia Prima", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            try
            {
                nLineIdOC = Convert.ToInt32(t_numoc.Text);
            ...
            int nCant_Total_Bins_D, nMaximo, nStock;
            double nCant_Bins;
            ...
            if (nCant_Total_Bins_D == 0)
            {
                MessageBox.Show("Debe ingresar un detalle de bins, opción Cancelada", "Recepción de Materia Prima", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;

            }

            t_CantBins.Text = nCant_Total_Bins_D.ToString();
            ...
            string CardCode_Serv, CardName_Serv;
            string cVARIEDAD, cPRESENTACION;
            ...
            mensaje = clsRecepcion.SAPB1_Recepcion(0, nId_Romana, VariablesGlobales.glb_User_id, cLocalidad);
            ...
            if (nNumGuia == 0)
            {
                MessageBox.Show("Debe ingresar un número de guía válido, opción Cancelada", "Recepción de Materia Prima", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            if (nPesoGuia == 0)
            {
                MessageBox.Show("Debe ingresar un peso de guía válido, opción Cancelada", "Recepción de Materia Prima", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            mensaje = clsRomana.SAPB1_ROMANA2(nId_Romana, nLineId, cCardCode, cCardName, cItemCode, cItemName, cItemCodeBins, nCantidadBins, nNumOC, 0,"", t_codigo_CSG.Text, nLineIdOC,"");
            ...
            mensaje = clsRecepcion.Entrada_Mercaderia(cCardCode, cCardName, cItemCode, nNumGuia, cPatente, cConductor, dt.ToString("yyyyMMdd"), float.Parse(nPesoNeto.ToString()), t_lote_maquilador.Text, float.Parse(nPesoGuia.ToString()), cWareHouse, nPrecioXUnidad, nPurchaseOrder, nBaseLineNum, nLote, nCantidadBins, CardCode_Serv, CardName_Serv, cTipoLote, UsuarioSap, ClaveSap, cVARIEDAD, cPRESENTACION, "52", t_codigo_CSG.Text,"");
            ...
            //clsRomana objproducto7 = new clsRomana();
            //objproducto7.cls_Consulta_Partidas_x_id_Entrada(nEntradaMercaderiaEntry, 20);

            clsRecepcion objproducto7 = new clsRecepcion();
            objproducto7.cls_Consulta_EntradaMercaderia_x_DocEntry_en_Detalle(nEntradaMercaderiaEntry, 0);
            ...
            try
            {
                ...
                nLote = int.Parse(dTable7.Rows[0]["Lote"].ToString());
            }
            catch
            {
                nLote = 0;
            ...
            try
            {
                cDistNumber = dTable7.Rows[0]["Lote"].ToString();
            }
            catch
            {
                cDistNumber = "";
            ...
            if (cDistNumber == "")
            {
                ...
                DataTable dTable8 = new DataTable();
                dTable8 = objproducto.cResultado;

                try
                {
                    nLote = int.Parse(dTable8.Rows[0]["MdAbsEntry"].ToString());
        ...
        private void btn_buscar1_Click(object sender, EventArgs e)
        {
            ...
            if (VariablesGlobales.glb_CardCode.Trim() != "")
            {
                ...
                t_lineidoc.Text = VariablesGlobales.glb_LineId.ToString();
        ...
        private void Suma_envases()
        {
            ...
            t_CantBins.Text = nCantBins_t.ToString();
        ...
        private void t_peso_neto_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                nPesoNeto = int.Parse(t_peso_neto.Text); 
            }
            catch
            {
                nPesoNeto = 0;
            ...
            t_peso_neto.Text = nPesoNeto.ToString();

        }

        private void t_peso_guia_Leave(object sender, EventArgs e)
        {
            int nPesoGuia;
            ...
            try
            {
                nPesoGuia = int.Parse(t_peso_guia.Text);
            }
            catch
            {
                nPesoGuia = 0;
            ...
            t_peso_guia.Text = nPesoGuia.ToString();
