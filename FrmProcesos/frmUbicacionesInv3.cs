...
{
    public partial class frmUbicacionesInv3 : Form
    {
        public frmUbicacionesInv3()
        {
            InitializeComponent();
        }

        private void frmUbicacionesInv3_Load(object sender, EventArgs e)
        {
            carga_grilla();
        ...
        private void carga_grilla()
        {
            ...
            try
            {
                ...
                objproducto.cls_ConsultaLista_Ubicacion_Lote("D", VariablesGlobales.glb_Pallet,"");
                ...
                for (int i = 0; i <= dTable.Rows.Count - 1; i++)
                {
                    ...
                    try
                    {
                        nQuantity = Convert.ToDouble(dTable.Rows[i]["Quantity_Ubicacion"].ToString());
                    }
                    catch
                    {
                        nQuantity = 0;
