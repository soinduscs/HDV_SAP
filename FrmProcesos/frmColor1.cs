...
{
    public partial class frmColor1 : Form
    {
        public frmColor1()
        {
            InitializeComponent();
        ...
        private void frmColor1_Load(object sender, EventArgs e)
        {
        ...
        private void btn_ok_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                mensaje = clsMaestros.TablaUsuario_Color(cCode, cName, UsuarioSap, ClaveSap);
            }
            catch
            {
