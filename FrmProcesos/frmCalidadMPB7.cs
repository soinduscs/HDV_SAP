...
{
    public partial class frmCalidadMPB7 : Form
    {
        public frmCalidadMPB7()
        {
            InitializeComponent();
        }

        private void frmCalidadMPB7_Load(object sender, EventArgs e)
        {
        ...
        private void carga_grilla(string accion, string dato1, string dato2)
        {
            ...
            try
            {
                ...
                double nPesoGI, nPesoGT;

                clsCalidad objproducto = new clsCalidad();
                objproducto.cls_Consulta_Recepcion_MP_Calidad_Secado_dys(accion, dato1, dato2);
                ...
                for (int i = 0; i <= dTable.Rows.Count - 1; i++)
                {
                    ...
                    try
                    {
                        cItemName = dTable.Rows[i]["Variedad_pdn1"].ToString();
                    }
                    catch
                    {
                        cItemName = "";
                    ...
                    try
                    {
                        nPesoGI = Convert.ToDouble(dTable.Rows[i]["Quantity"].ToString());
                    }
                    catch
                    {
                        nPesoGI = 0;
                    ...
                    try
                    {
                        nPesoGT = Convert.ToDouble(dTable.Rows[i]["Peso_GT"].ToString());
                    }
                    catch
                    {
                        nPesoGT = 0;
                    ...
                    grilla[8] = nPesoGI.ToString("N");                    
                    grilla[9] = cStatusCalidad;
                    grilla[10] = nCantRegistros.ToString();
                    grilla[11] = nIdCalidad.ToString();
                    grilla[12] = cItemCode;
                    grilla[13] = cPelon;
                    grilla[14] = cNumOFSecado;
                    grilla[15] = cLoteSecado;
                    grilla[16] = nPesoGT.ToString("N");
                    grilla[17] = cEstadoSecado;
                    grilla[18] = idCalidadSecado.ToString();
                    grilla[19] = cDocEntry_TR;
                    grilla[20] = cItemCode_TR;
                    ...
                    if (cMuestra == "S")
                    {
                        ...
                        if (cStatusCalidad == "Inspección no Registrada")
                        {
                            Grid1[9, nFila].Style.BackColor = Color.Empty;
                        }

                        if (cStatusCalidad == "Inspección en Proceso")
                        {
                            Grid1[9, nFila].Style.BackColor = Color.Yellow;
                        }

                        if (cStatusCalidad == "Inspección Finalizada - Aprobado")
                        {
                            Grid1[9, nFila].Style.BackColor = Color.Green;
                        }

                        if (cStatusCalidad == "Inspección Finalizada - Rechazado")
                        {
                            Grid1[9, nFila].Style.BackColor = Color.Red;
                        }
                        ...
                        {
                            Grid1[17, nFila].Style.BackColor = Color.Empty;
                        }

                        if (cEstadoSecado == "Inspección en Proceso")
                        {
                            Grid1[17, nFila].Style.BackColor = Color.Yellow;
                        }

                        if (cEstadoSecado == "Inspección Finalizada - Aprobado")
                        {
                            Grid1[17, nFila].Style.BackColor = Color.Green;
                        }

                        if (cEstadoSecado == "Inspección Finalizada - Aprobado C/Reparos")
                        {
                            Grid1[17, nFila].Style.BackColor = Color.Orange;
                        }

                        if (cEstadoSecado == "Inspección Finalizada - Rechazado")
                        {
                            Grid1[17, nFila].Style.BackColor = Color.Red;
                        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                id_calidad = Convert.ToInt32(Grid1[11, fila].Value.ToString().ToUpper());
            ...
            try
            {
                nCantAnalisis = Convert.ToInt32(Grid1[10, fila].Value.ToString().ToUpper());
            ...
            try
            {
                cItemCode = Grid1[12, fila].Value.ToString().ToUpper();
            }
            catch
            {
                cItemCode = "";
            ...
            try
            {
                cPelon = Grid1[13, fila].Value.ToString().ToUpper();
            }
            catch
            {
                cPelon = "NO";
            ...
            if (id_calidad == 0)
            {
                ...
                try
                {
                    id_romana = Convert.ToInt32(Grid1[2, fila].Value.ToString().ToUpper());
                ...
                VariablesGlobales.glb_Object = "100502";
                VariablesGlobales.glb_id_romana = Convert.ToInt32(Grid1[0, fila].Value.ToString().ToUpper()); //id_romana;
                VariablesGlobales.glb_LineId = nLineId;
                VariablesGlobales.glb_ItemCode = cItemCode;
                VariablesGlobales.glb_DocEntry = Convert.ToInt32(Grid1[0, fila].Value.ToString().ToUpper());
        ...
        private void btn_actualizar_Click(object sender, EventArgs e)
        {
            ...
            String mensaje = clsCalidad.SAPB1_ORCAL9v1(id_docentry);
        ...
        private void btn_calidad_secado_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                nIdCalidad = Convert.ToInt32(Grid1[18, fila].Value.ToString().ToUpper());
            ...
            try
            {
                nLote = Convert.ToInt32(Grid1[15, fila].Value.ToString().ToUpper());
            ...
            try
            {
                nDocEntry_TR = Convert.ToInt32(Grid1[19, fila].Value.ToString().ToUpper());
            ...
            try
            {
                cItemCode_TR = Grid1[20, fila].Value.ToString().ToUpper();
