...
{
    public partial class frmCalidadMP2 : Form
    {
        public frmCalidadMP2()
        {
            InitializeComponent();
        }


        private void frmCalidadMP2_Load(object sender, EventArgs e)
        {
            Boolean exists;
        ...
        private void carga_datos_x_id()
        {
            ...
            string CardCode, CardName, cLoteInterno;
            ...
            string cItemName_D, cStatusCalidad, cCodigoCSG_D;
            ...
            for (int i = 0; i <= dTable.Rows.Count - 1; i++)
            {
                ...
                try
                {
                    cCodigoCSG_D = dTable.Rows[i]["U_Codigo_CSG"].ToString();
                ...
                try
                {
                    cLoteInterno = dTable.Rows[i].ItemArray[59].ToString();
                }
                catch
                {
                    cLoteInterno = "0";
                ...
                grilla[4] = cCodigoCSG_D.ToUpper(); 
                grilla[5] = cItemCode_D.ToUpper();
                grilla[6] = cItemName_D.ToUpper();
                grilla[7] = cLoteInterno;
                grilla[8] = ItemCodeBins;
                grilla[9] = Convert.ToString(nCantBins_D);
                grilla[10] = Convert.ToString(n_PesoUnitBins_D);
                grilla[11] = cStatusCalidad;
                grilla[12] = nCantAnalisis_D.ToString();
                grilla[13] = Convert.ToString(nLineasAnalisis_D);
                grilla[14] = Convert.ToString(nCantAtributos);
                
                Grid1.Rows.Add(grilla);

                if (cStatusCalidad == "Inspección no Registrada")
                {
                    Grid1[11, i].Style.BackColor = Color.Empty;
                }

                if (cStatusCalidad == "Inspección en Proceso")
                {
                    Grid1[11, i].Style.BackColor = Color.Yellow;
                }

                if (cStatusCalidad == "Inspección Finalizada - Aprobado")
                {
                    Grid1[11, i].Style.BackColor = Color.Green;
                }

                if (cStatusCalidad == "Inspección Finalizada - Rechazado")
                {
                    Grid1[11, i].Style.BackColor = Color.Red;
                }
        ...
        private void btn_analisis_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                nLineaAnalisis = Convert.ToInt32(Grid1[14, fila].Value.ToString());
            }
            catch
            {
                nLineaAnalisis = 0;
            ...
            try
            {
                nIdCalidad = Convert.ToInt32(Grid1[13, fila].Value.ToString());
            }
            catch
            {
                nIdCalidad = 0;
            ...
            try
            {
                nCantAnalisis = Convert.ToInt32(Grid1[12, fila].Value.ToString());
            ...
            VariablesGlobales.glb_Referencia3 = "";
            ...
            if (nCantAnalisis <= 1)
            {
                ...
                if (Grid1.Columns[6].Visible == true)
                {

                    if (VariablesGlobales.glb_Referencia3 != "")
                    {
