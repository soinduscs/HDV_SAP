...
{
    public partial class frmSolicitudTraslado1 : Form
    {
        public frmSolicitudTraslado1()
        {
            InitializeComponent();
        }

        private void frmSolicitudTraslado1_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string cItemName, cExiste, cAlmacen;
            string cAlmacen_D;
            ...
            for (int j = 0; j <= Grid3.RowCount - 1; j++)
            {
                cLote = Grid3[0, j].Value.ToString();

                if (cLote != "")
                {

                    clsProduccion objproducto = new clsProduccion();
                    objproducto.cls_Consulta_Lote_y_Stock(cLote, "%");
                    ...
                    for (int i = 0; i <= dTable.Rows.Count - 1; i++)
                    {
                        ...
                        try
                        {
                            nNumOF = Convert.ToInt32(dTable.Rows[i]["OF_Asignada"].ToString());
                        }
                        catch
                        {
                            nNumOF = 0;
                        ...
                        grilla[4] = cLote_D;
                        grilla[5] = cAlmacen;
                        grilla[6] = nStock.ToString("N2");
                        grilla[7] = "";

                        if (nNumOF > 0)
                        {
                            grilla[7] = "Lote asignado a OF " + nNumOF.ToString();
                        ...
                        for (int j1 = 0; j1 <= Grid2.RowCount - 1; j1++)
                        {
                            cItemCode_D = "";
                            cAlmacen_D = "";
                            ...
                            try
                            {
                                cItemCode_D = Grid2[0, j1].Value.ToString();
                            }
                            catch
                            {
                                cItemCode_D = "";
                            ...
                            try
                            {
                                cAlmacen_D = Grid2[1, j1].Value.ToString();
                            }
                            catch
                            {
                                cAlmacen_D = "";
                            ...
                            if ((cItemCode == cItemCode_D) && (cAlmacen == cAlmacen_D))
                            {
                                cExiste = "S";
                                break;
                            }
            ...
            for (int j = 0; j <= Grid2.RowCount - 1; j++)
            {
                ...
                try
                {
                    cAlmacen = Grid2[1, j].Value.ToString();
                }
                catch
                {
                    cAlmacen = "";
                ...
                for (int i = 0; i <= Grid1.RowCount - 1; i++)
                {
                    ...
                    try
                    {
                        cAlmacen_D = Grid1[5, i].Value.ToString();
                    }
                    catch
                    {
                        cAlmacen_D = "";
                ...
                Grid2[2, j].Value = nStock.ToString();
            ...
            string cError, cLote2, cAlmacen2;
            cError = "N";
            ...
            for (int j = 0; j <= Grid1.RowCount - 1; j++)
            {
                ...
                cAlmacen = Grid1[5, j].Value.ToString();

                for (int k = j + 1; k <= Grid1.RowCount - 1; k++)
                {
                    cLote2 = Grid1[0, k].Value.ToString();
                    cAlmacen2 = Grid1[5, k].Value.ToString();

                    if ((cLote == cLote2) && (cAlmacen == cAlmacen2))
                    {
                        ...
                        Grid1[7, k].Style.BackColor = Color.Red;
        ...
        private void btn_genera_solicitud_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= Grid2.RowCount - 1; i++)
            {
                ...
                try
                {
                    cWhsCode = Grid2[1, i].Value.ToString();
                }
                catch
                {
                    cWhsCode = "";
                ...
                try
                {
                    nQuantity = Convert.ToDouble(Grid2[2, i].Value.ToString());
                }
                catch
                {
                    nQuantity = 0;
            ...
            for (int i = 0; i <= Grid1.RowCount - 1; i++)
            {
                cLote_D = Grid1[4, i].Value.ToString();
                cItemCode_D = Grid1[1, i].Value.ToString();
                cItemName_D = Grid1[2, i].Value.ToString();

                try
                {
                    cWhsCode = Grid1[5, i].Value.ToString();
                }
                catch
                {
                    cWhsCode = "";
                ...
                try
                {
                    nQuantity = Convert.ToDouble(Grid1[6, i].Value.ToString());
                }
                catch
                {
                    nQuantity = 0;
