...
{
    public partial class frmCalidadPPA5 : Form
    {
        public frmCalidadPPA5()
        {
            InitializeComponent();
        }

        private void frmCalidadPPA5_Load(object sender, EventArgs e)
        {
        ...
        private void carga_grilla1(string accion, string dato1, string dato2)
        {
            ...
            try
            {
                ...
                objproducto.cls_SAPB1_ROMANA8("R");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (id_romana > 0)
            {
                ...
                VariablesGlobales.glb_Razon_Ingreso = "R";
