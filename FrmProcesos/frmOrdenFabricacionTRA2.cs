...
{
    public partial class frmOrdenFabricacionTRA2 : Form
    {
        public frmOrdenFabricacionTRA2()
        {
            InitializeComponent();
        }

        private void frmOrdenFabricacionTRA2_Load(object sender, EventArgs e)
        {
            ...
            // TODO: esta línea de código carga datos en la tabla 'HDV_P03DataSet11.SAPB1_OPRODUCCION' Puede moverla o quitarla según sea necesario.
