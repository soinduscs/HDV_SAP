...
{
    public partial class frmCalidadPPA3 : Form
    {
        public frmCalidadPPA3()
        {
            InitializeComponent();
        }

        private void frmCalidadPPA3_Load(object sender, EventArgs e)
        {
            ...
            //Partidura Manual
            if ((t_tipo_proceso.Text == "Cracker Nueces") || (t_tipo_proceso.Text == "Sorter 1") || (t_tipo_proceso.Text == "Sorter 2") || (t_tipo_proceso.Text == "Selección Nueces") || (t_tipo_proceso.Text == "Secado"))
            {
            ...
            {
                if ((t_tipo_proceso.Text == "Agup. Sem. Elab") || (t_tipo_proceso.Text == "Limpieza Nueces") || (t_tipo_proceso.Text == "Selección Nueces M") || (t_tipo_proceso.Text == "Partidura Manual"))
                {
                    cTipoFruta_Combo = "Nuez";
        ...
        private void carga_datos_produccion()
        {
            ...
            if (VariablesGlobales.glb_Razon_Ingreso == "R")
            {
            ...
            {
                objproducto.cls_Consulta_Consumo_x_id(DocEntry, LineId, t_lote.Text);
            ...
            for (int i = 0; i <= dTable2.Rows.Count - 1; i++)
            {
                ...
                //////////////////////////////////////
                //////////////////////////////////////
                // Como es humedad solo se cargan
                // los valores PM_01

                if ((cCode_D == "PM_1_001") || (cCode_D == "PM_1_002") || (cCode_D == "PM_1_003"))
                {
        ...
        private void btn_ok_Click(object sender, EventArgs e)
        {
            ...
            String mensaje = clsCalidad.SAPB1_ORCAL(nDocEntry, "N", UserId, UserCode, cItemCode, cItemName, cWhsCode, "", cNumCon, cLote, nCantidad, 0, 0, dt.ToString("yyyyMMdd"), cUM, 0, 0, t_Comments.Text, cObjetc, nDocEntryRef, nLineIdRef, cCalibreNuez, cColorNuez,0,"","S","","");
        ...
        private void aprobacion_directa(string estado)
        {
            ...
            if (nDocEntry > 0)
            {
                ...
                if (result == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    mensaje = clsCalidad.SAPB1_ORCAL(nDocEntry, estado, UserId, UserCode, cItemCode, cItemName, cWhsCode, cWhsDest, cNumCon, cLote, nCantidad, nBultos, nBultosMuestrear, cFecha, cUM, nCoMuSize, nMuDeSize, Comments, cObjetc, nDocEntryRef, nLineId_Ref, cCalibreNuez, cColorNuez,0,"","S","","");
