...
{
    public partial class frmRomana7 : Form
    {
        public frmRomana7()
        {
            InitializeComponent();
        ...
        private void frmRomana7_Load(object sender, EventArgs e)
        {
            Boolean exists;
        ...
        private void btn_graba_bruto_Click(object sender, EventArgs e)
        {
            ...
            if (t_PesoBalanza.Text == "E_")
            {
                if (VariablesGlobales.glb_User_Code.ToUpper() == "MANAGER")
                {
                    ...
                    t_peso_bruto.Text = textBox1.Text;

                }

            }

            if (t_DocNum.Text.Trim() == "")
            {
                MessageBox.Show("Debe ingresar una orden de fabricación válido, opción Cancelada", "Recepción de Carga", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void btn_ok_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                nPesoTotal = Convert.ToDouble(t_peso_bruto.Text);
            ...
            try
            {
                nPesoTara = Convert.ToDouble(t_tara.Text);
            ...
            try
            {
                nPesoTotal_D = Convert.ToDouble(t_tara.Text);
