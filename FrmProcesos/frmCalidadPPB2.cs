...
{
    public partial class frmCalidadPPB2 : Form
    {
        public frmCalidadPPB2()
        {
            InitializeComponent();
        }

        private void frmCalidadPPB2_Load(object sender, EventArgs e)
        {
        ...
        private void carga_detalle()
        {
            ...
            objproducto2.cls_Consulta_ATRP9l(t_codatr.Text, t_referencia.Text);
            ...
            string cCode_D, cNomAtributo_D, cAccion_D;
            ...
            for (int i = 0; i <= dTable2.Rows.Count - 1; i++)
            {
                ...
                try
                {
                    cAccion_D = dTable2.Rows[i]["U_Accion"].ToString();
                }
                catch
                {
                    cAccion_D = "";
        ...
        private void btn_agregar_Click(object sender, EventArgs e)
        {
            ...
            frmCalidadPPB3 f2 = new frmCalidadPPB3();
            ...
            if (VariablesGlobales.glb_CodAtrD != "")
            {
                ...
                clsCalidad objproducto2 = new clsCalidad();
                objproducto2.cls_Consulta_max_ATRP9l();
                ...
                mensaje = clsCalidad.U_Agregar_Linea_ATRP9(nDocEntry, t_codatr.Text, VariablesGlobales.glb_CodAtrD, cMatriz);
        ...
        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                mensaje = clsCalidad.U_Eliminar_Linea_ATRP9(t_codatr.Text, cCodAtr, cMatriz);
        ...
        private void Grid2_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            mensaje = clsCalidad.U_Actualiza_Linea_ATRP9(Convert.ToInt32(cDocEntry), cAccion);
