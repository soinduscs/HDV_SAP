...
{
    public partial class frmOrdenFabricacionTRA3 : Form
    {
        public frmOrdenFabricacionTRA3()
        {
            InitializeComponent();
        }

        private void frmOrdenFabricacionTRA3_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                SAPB1_OPRODUCCIONTableAdapter.Fill(this.HDV_P03DataSet27.SAPB1_OPRODUCCION, nEntMercaderia, "%", cObjeto, cLote);
