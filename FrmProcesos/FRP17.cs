...
{
    public partial class FRP17 : Form
    {
        public FRP17()
        {
            InitializeComponent();
        ...
        private void FRP17_Load(object sender, EventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            lbl_hora.Text = fecha_hora.ToString("HH:MM:ss");

        }

        private void FRP17_FormClosed(object sender, FormClosedEventArgs e)
        {
