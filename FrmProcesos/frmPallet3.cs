...
{
    public partial class frmPallet3 : Form
    {
        public frmPallet3()
        {
            InitializeComponent();
        ...
        private void frmPallet3_Load(object sender, EventArgs e)
        {
        ...
        private void btn_genera_pallet_Click(object sender, EventArgs e)
        {
            ...
            mensaje = clsOrdenFabricacion.Entrada_Mercaderia_Borra_Pallet(t_pallet_full.Text, d_arrDetalle, UsuarioSap, ClaveSap);

            ///////////////////////////////////////////////
            ///////////////////////////////////////////////
            //// 
            //// Vinculo los lotes al nuevo pallet
            ...
            btn_borra_lote.Enabled = false;

        }

        private void btn_borra_lote_Click(object sender, EventArgs e)
        {
            string cToWhs = "";
            ...
            result = MessageBox.Show("Esta Seguro de Dejar Sin pallet los Lotes seleccionados", "Gestión de Pallet ", buttons);
