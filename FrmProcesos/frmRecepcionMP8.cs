...
{
    public partial class frmRecepcionMP8 : Form
    {
        public frmRecepcionMP8()
        {
            InitializeComponent();
        }

        private void frmRecepcionMP8_Load(object sender, EventArgs e)
        {
            ...
            for (int x = 0; x <= nMaximo; x++)
            {
                ...
                try
                {
                    nCantBins = 0;  //VariablesGlobales.glb_Array1[x];
                ...
                if (nCantBins > 0)
                {
                    for (int i = 0; i <= Grid1.RowCount - 1; i++)
                    {
                        ...
                        {
                            Grid1[2, i].Value = 0; // nCantBins.ToString();
        ...
        private void carga_peso_balanza()
        {

            ///////////////////////////////////////////////////////
            ///////////////////////////////////////////////////////
            ///////////////////////////////////////////////////////
            // Carga Datos de Balanza 

            int nDocEntry, nLineId;
            string cItemCode_Bins, cItemCode;
            ...
            double dPesoUnitario, dPesoFinal;
            int dEnvases, dTotalEnvases;

            clsRomana objproducto5 = new clsRomana();
            objproducto5.cls_Consulta_Detalles_Balanza1(nDocEntry, nLineId);

            DataTable dTable3 = new DataTable();
            dTable3 = objproducto5.cResultado;
            ...
            for (int i = 0; i <= dTable3.Rows.Count - 1; i++)
            {
                ...
                try
                {
                    dPesoUnitario = Convert.ToDouble(dTable3.Rows[i]["PesoNeto"].ToString());
                }
                catch
                {
                    dPesoUnitario = 0;
                ...
                dPesoFinal += dPesoUnitario;

                cItemCode = dTable3.Rows[i]["U_ItemCode"].ToString();

                try
                {
                    dEnvases = int.Parse(dTable3.Rows[i]["Envases"].ToString());
                }
                catch
                {
                    dEnvases = 0;
                ...
                if (cItemCode != "_")
                {
                    ...
                    for (int j = 0; j <= Grid1.RowCount - 1; j++)
                    {
                        ...
                        try
                        {
                            cItemCode_Bins = Grid1[0, j].Value.ToString();
                        }
                        catch
                        {
                            cItemCode_Bins = "";
                        ...
                        if (cItemCode == cItemCode_Bins)
                        {
                            Grid1[2, j].Value = dEnvases.ToString();
                        }
            ...
            t_cant_bins.Text = dTotalEnvases.ToString();
            t_peso_neto.Text = dPesoFinal.ToString("N2");
        ...
        private void btn_recibir_Click(object sender, EventArgs e)
        {
            ...
            objproducto.cls_Consultar_Ordenes_de_compra_x_numero(nNumOC, cItemCode,0);
            ...
            mensaje = clsRomana.SAPB1_ROMANA2(nId_Romana, nLineId, cCardCode, cCardName, cItemCode, cItemName, cItemCodeBins, nCantidadBins, nNumOC, 0,"","",0,"");
            ...
            Application.DoEvents();
            t_mensaje.Text = "Grabación de registro - Recupero Lote " + t_lote.Text + " (6)...";
            Application.DoEvents();
            ...
            if (j > -1)
            {
                ...
                Application.DoEvents();
                t_mensaje.Text = "Grabación de registro - Transferencia de Lotes " + nStockTransferEntry.ToString() + " (8)...";
                Application.DoEvents();
            ...
            Application.DoEvents();
            t_mensaje.Text = "Grabación de registro - Actualizo el registro de Recepción 1 - (9)...";
            Application.DoEvents();
            ...
            if (nStockTransferEntry > 0)
            {
                ...
                Application.DoEvents();
                t_mensaje.Text = "Grabación de registro - Actualizo el registro de Recepción 2 - (10)...";
                Application.DoEvents();
        ...
        private void btn_peso_Click(object sender, EventArgs e)
        {
            ...
            frmRecepcionMP9 f2 = new frmRecepcionMP9();
            DialogResult res = f2.ShowDialog();
