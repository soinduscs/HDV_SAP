...
{
    public partial class frmOrdenFabricacionTR4_AR : Form
    {
        public frmOrdenFabricacionTR4_AR()
        {
            InitializeComponent();
        }

        private void frmOrdenFabricacionTR4_AR_Load(object sender, EventArgs e)
        {
            try
            {
