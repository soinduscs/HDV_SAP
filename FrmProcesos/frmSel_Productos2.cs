...
{
    public partial class frmSel_Productos2 : Form
    {
        public frmSel_Productos2()
        {
            InitializeComponent();
        }

        private void frmSel_Productos2_Load(object sender, EventArgs e)
        {
        ...
        private void carga_grilla()
        {
            ...
            try
            {
                ...
                objproducto.cls_consultar_Productos2(VariablesGlobales.glb_DocEntry);
