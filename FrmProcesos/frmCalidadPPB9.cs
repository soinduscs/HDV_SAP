...
{
    public partial class frmCalidadPPB9 : Form
    {
        public frmCalidadPPB9()
        {
            InitializeComponent();
        }

        private void frmCalidadPPB9_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                xSapb1_utiles_informeordenventa_calidadTableAdapter.Fill(this.HDV_P03DataSet41.xSapb1_utiles_informeordenventa_calidad, "N", VariablesGlobales.glb_DocEntry, VariablesGlobales.glb_ItemCode, nIdImagen);
