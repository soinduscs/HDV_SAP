...
{
    public partial class frmRecepcionMPC6 : Form
    {
        public frmRecepcionMPC6()
        {
            InitializeComponent();
        }

        private void frmRecepcionMPC6_Load(object sender, EventArgs e)
        {
        ...
        private void btn_recibir_Click(object sender, EventArgs e)
        {
            ...
            if (t_num_guia.Text == "")
            {
                MessageBox.Show("Debe ingresar una guía válida, opción Cancelada", "Recepción de Material Externo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            if (t_num_ov.Text == "")
            {
                MessageBox.Show("Debe ingresar un orden de venta válida, opción Cancelada", "Recepción de Material Externo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            {
                MessageBox.Show("Debe ingresar un detalle de bultos válido, opción Cancelada", "Recepción de Material Externo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            if (t_cardname.Text == "")
            {
                MessageBox.Show("Debe seleccionar un Proveedor válido, opción Cancelada", "Recepción de Material Externo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            if (t_itemname.Text == "")
            {
                MessageBox.Show("Debe seleccionar un insumo válido, opción Cancelada", "Recepción de Material Externo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            if (cAlmacen == "")
            {
                MessageBox.Show("Debe seleccionar un almacen válido, opción Cancelada", "Recepción de Material Externo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            if (nNumOC == 0)
            {
                MessageBox.Show("Debe seleccionar una Orden de Compra válida, opción Cancelada", "Recepción de Material Externo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            //mensaje = clsRecepcion.Entrada_Mercaderia(cCardCode, cCardName, cItemCode, nNumGuia, "", "", dt.ToString("yyyyMMdd"), 0, t_lote_maquilador.Text, float.Parse(nPesoGuia.ToString()), cWareHouse, nPrecioXUnidad, nPurchaseOrder, nBaseLineNum, nLote, nCantidadBins, CardCode_Serv, CardName_Serv, cTipoLote, UsuarioSap, ClaveSap, cVARIEDAD, cPRESENTACION, "52", t_codigo_CSG.Text, "");

            mensaje = clsRecepcion.Entrada_Mercaderia_Bodegaje(cCardCode, cCardName, cItemCode, nNumGuia, dt.ToString("yyyyMMdd"), "", cWareHouse, nPurchaseOrder, nBaseLineNum, nCantBultos, CardCode_Serv, CardName_Serv, "", d_arrDetalle, d_arrDetalle1, t_num_ov.Text, UsuarioSap, ClaveSap);
        ...
        private void btn_buscar1_Click(object sender, EventArgs e)
        {
            ...
            frmSel_OrdendeCompra4 f2 = new frmSel_OrdendeCompra4();
