...
{
    public partial class frmCalidadMPA7 : Form
    {
        public frmCalidadMPA7()
        {
            InitializeComponent();
        }

        private void frmCalidadMPA7_Load(object sender, EventArgs e)
        {
        ...
        private void carga_grilla(string accion, string dato1, string dato2)
        {
            ...
            try
            {
                ...
                for (int i = 0; i <= dTable.Rows.Count - 1; i++)
                {
                    ...
                    grilla[9] = nDocEntry_Calidad.ToString();
