...
{
    public partial class frmOrdenFabricacionTR7_AR : Form
    {
        public frmOrdenFabricacionTR7_AR()
        {
            InitializeComponent();
        }

        private void frmOrdenFabricacionTR7_AR_Load(object sender, EventArgs e)
        {
            try
            {
